...
class PhpIniRequirement extends Requirement
{
    ...
    public function __construct(
        $cfgName, $evaluation, $approveCfgAbsence = false, $testMessage = null, $helpHtml = null, $helpText = null,
        $optional = false
    ) {
        ...
        parent::__construct(
            $fulfilled || ($approveCfgAbsence && false === $cfgValue), $testMessage, $helpHtml, $helpText, $optional
        );
    }
}
...
class SymfonyRequirements extends RequirementCollection
{
    ...
    public function __construct()
    {
        ...
        $this->addRequirement(
            ...
            sprintf(
                'Install PHP %s or newer (installed version is %s)', self::REQUIRED_PHP_VERSION, $installedPhpVersion
            )
        );
